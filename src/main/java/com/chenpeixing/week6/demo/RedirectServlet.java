...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //2.start with /
        response.sendRedirect("/2019211001001220ChenPeiXing_war_exploded/index.jsp");//-???-HTTP Status 404-Not Found
        //why?-look at url
        ////http://localhost:8080/2019211001001218LiuHeng_war_exploded/redirect
        //http://localhost:8080/index.jsp
        //url change after 8080-means tomcat
        //add /2019211001001220ChenPeiXing_war_exploded/
